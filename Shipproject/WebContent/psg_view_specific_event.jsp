...
<html>
  ...
  <div class="regHeader">
      <div class="logo"><h1><a href="<c:url value='/psg_homepage.jsp' />">Event Details</a></h1></div>
  <div class="menu_nav">
    </div>
  </div>					
  <body>
  <form action="<c:url value='registerEventController?action=registerSpecifiedEvent' />" method="post">
    <div class="bodyreg">
